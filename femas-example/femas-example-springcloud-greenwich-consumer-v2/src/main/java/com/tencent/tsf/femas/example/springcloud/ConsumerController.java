...
import com.tencent.tsf.femas.example.springcloud.proxy.service.ProviderService;
...
public class ConsumerController {
    ...
    public Object services() {
        return discoveryClient.getInstances("femas-springcloud-provider");
    }

    @RequestMapping("/discover")
    public Object discover() {
        return loadBalancer.choose("femas-springcloud-provider").getUri().toString();
    }
    ...
    public String feignHelloProvider(@RequestParam(required = false) String tagName,
        ...
        LOG.info(hello);
        return "consumer say hello v2 >> " + hello;
    }
    ...
    public String restEchoErrorProvider(@PathVariable String str,
        ...
        return restTemplate.getForObject("http://femas-springcloud-provider/echo/error/" + str, String.class);
    }
